...
A demanda mensal é a quantidade paga menos unidades reembolsadas. O modelo cobre os 50 produtos de maior giro no período de treino e utiliza defasagens de 1, 2, 3, 6 e 12 meses, médias móveis, sazonalidade cíclica e tendência. A seleção dos produtos ocorre antes da janela de teste para evitar vazamento temporal.
